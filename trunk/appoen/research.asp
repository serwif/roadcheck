...
Function jsresearch(strsite)
	...
	javastr=javastr+TTitle(strsite,"网站调查")
	...
	if not rs.eof then
		...
		javastr=javastr+"<form action=""researchresult.asp"" target=""newwindow"" method=post name=research><tr><td valign=top class="&TitleClass&">"		
		dim ischecked
		for i=1 to 8
