...
dim conn, rs, rs1,rsMX,rs2,rs3, sql,sql1,sql2,sql3,sql4,sql5, errmsg, founderror, i, str1, mode, cpage, fl,dwx,unit_code,shj1,shj2,byhj,bnlj,bbjzdwmc,bbjzzg,bbjzfh,bbjzzb
...
%>
  ...
  {//求大类的小类列表
   ...
   //alert(i);
   location.href="searchtxfsr.asp?mode=1&unit_code="+unit_code;             
   return false;
  }
  //-->
  </script>
...
sub ShowInputForm3(errmsg)
  ...
  %>
  <form method="POST" action="searchtxfsr.asp?mode=1" name="input3">
  <br>
  <table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr bgcolor=<%=skincolor()%> height="28">
      <td align="center"><b>通行费收入统计表查询</b></td>
    </tr>
...
if mode=1 then
  ...
  if trim(request("shj2")) <> "0" and trim(request("shj2"))<>"" then
    ...
    if trim(request("shj2")) <> "0" and trim(request("shj2"))<>"" then
      ...
      sql1=sql1 & " (shj1 like '" + trim(request("shj1")) +trim(request("shj2")) + "%')"
      ...
      <table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td align="right" colspan="2">
            [<a href="searchtxfsr.asp?mode=1">继续查找</a>]
          </td>
        </tr>
        <tr>
          ...
          <td colspan="2">
            <table width="100%" border="1" cellspacing="0" cellpadding="0" align="center" bordercolorlight="#000000" bordercolordark="#FFFFFF">
              <tr bgcolor=<%=skincolor()%>>
                ...
                <td width=140 align=center>本月收入(元)</td>
                <td width=140 align=center>本年累计收入(元)</td>
              </tr>
              <%
              byhj=0
              bnlj=0
              fl=true
              rs.close
              rs.open "select * from ajlb where left(ajlb_code," & ajlb_len2 & ")='" & left("0301000000",ajlb_len2) &"' and right(ajlb_code,"& (ajlb_len0-ajlb_len3) & ")='" & ajlb_str3 &"' and mid(ajlb_code,"& (ajlb_len2+1) & "," & (ajlb_len3-ajlb_len2) & ")<>'00' order by ajlb_sxh", conn, 1, 1
              if rs.recordcount>0 then
                'response.write "select ajlb.ajlb_code,sum(edzdjb_x03.ajlbV) as expr1 from edzdjb03,edzdjb_x03,ajlb where edzdjb03.bh=edzdjb_x03.bh and edzdjb_x03.ajlb_code=ajlb.ajlb_code and left(ajlb.ajlb_code," & ajlb_len2 & ")='" & left(rs("ajlb_code"),ajlb_len2) &"' and right(ajlb.ajlb_code,"& (ajlb_len0-ajlb_len3) & ")='" & ajlb_str3 &"' and mid(ajlb.ajlb_code,"& (ajlb_len2+1) & "," & (ajlb_len3-ajlb_len2) & ")<>'00' " & sql1 & " group by ajlb.ajlb_code"
                rs1.open "select ajlb.ajlb_code,sum(edzdjb_x03.ajlbV) as expr1 from edzdjb03,edzdjb_x03,ajlb where edzdjb03.bh=edzdjb_x03.bh and edzdjb_x03.ajlb_code=ajlb.ajlb_code and left(ajlb.ajlb_code," & ajlb_len2 & ")='" & left(rs("ajlb_code"),ajlb_len2) &"' and right(ajlb.ajlb_code,"& (ajlb_len0-ajlb_len3) & ")='" & ajlb_str3 &"' and mid(ajlb.ajlb_code,"& (ajlb_len2+1) & "," & (ajlb_len3-ajlb_len2) & ")<>'00' " & sql1 & " group by ajlb.ajlb_code", conn, 1, 1
                rs2.open "select ajlb.ajlb_code,sum(edzdjb_x03.ajlbV) as expr1 from edzdjb03,edzdjb_x03,ajlb where edzdjb03.bh=edzdjb_x03.bh and edzdjb_x03.ajlb_code=ajlb.ajlb_code and left(ajlb.ajlb_code," & ajlb_len2 & ")='" & left(rs("ajlb_code"),ajlb_len2) &"' and right(ajlb.ajlb_code,"& (ajlb_len0-ajlb_len3) & ")='" & ajlb_str3 &"' and mid(ajlb.ajlb_code,"& (ajlb_len2+1) & "," & (ajlb_len3-ajlb_len2) & ")<>'00' " & sql2 & " group by ajlb.ajlb_code", conn, 1, 1
                response.write "<tr>"
                response.write "<td align=center rowspan="&rs.recordcount&">次票和微机票据收入</td>"
                do while not rs.eof 
                  if not fl then
                    response.write "<tr>"
                    fl=true
                  end if
                  response.write "<td>" & rs("ajlb_name") & "</td>"
              ...
              rs.close
              fl=true
              rs.open "select * from ajlb where left(ajlb_code," & ajlb_len2 & ")='" & left("0302000000",ajlb_len2) &"' and right(ajlb_code,"& (ajlb_len0-ajlb_len3) & ")='" & ajlb_str3 &"' and mid(ajlb_code,"& (ajlb_len2+1) & "," & (ajlb_len3-ajlb_len2) & ")<>'00' order by ajlb_sxh", conn, 1, 1
              if rs.recordcount>0 then
                rs1.open "select ajlb.ajlb_code,sum(edzdjb_x03.ajlbV) as expr1 from edzdjb03,edzdjb_x03,ajlb where edzdjb03.bh=edzdjb_x03.bh and edzdjb_x03.ajlb_code=ajlb.ajlb_code and left(ajlb.ajlb_code," & ajlb_len2 & ")='" & left(rs("ajlb_code"),ajlb_len2) &"' and right(ajlb.ajlb_code,"& (ajlb_len0-ajlb_len3) & ")='" & ajlb_str3 &"' and mid(ajlb.ajlb_code,"& (ajlb_len2+1) & "," & (ajlb_len3-ajlb_len2) & ")<>'00' " & sql1 & " group by ajlb.ajlb_code", conn, 1, 1
                rs2.open "select ajlb.ajlb_code,sum(edzdjb_x03.ajlbV) as expr1 from edzdjb03,edzdjb_x03,ajlb where edzdjb03.bh=edzdjb_x03.bh and edzdjb_x03.ajlb_code=ajlb.ajlb_code and left(ajlb.ajlb_code," & ajlb_len2 & ")='" & left(rs("ajlb_code"),ajlb_len2) &"' and right(ajlb.ajlb_code,"& (ajlb_len0-ajlb_len3) & ")='" & ajlb_str3 &"' and mid(ajlb.ajlb_code,"& (ajlb_len2+1) & "," & (ajlb_len3-ajlb_len2) & ")<>'00' " & sql2 & " group by ajlb.ajlb_code", conn, 1, 1
                response.write "<tr>"
                response.write "<td align=center rowspan="&rs.recordcount&">月票收入</td>"
                do while not rs.eof 
                  if not fl then
                    response.write "<tr>"
                    fl=true
              ...
              rs.close
              fl=true
              rs.open "select * from ajlb where ajlb_code='" & "0303000000" &"' ", conn, 1, 1
              if rs.recordcount>0 then
                rs1.open "select sum(edzdjb_x03.ajlbV) as expr1 from edzdjb03,edzdjb_x03,ajlb where edzdjb03.bh=edzdjb_x03.bh and edzdjb_x03.ajlb_code=ajlb.ajlb_code and ajlb.ajlb_code='" & rs("ajlb_code") &"' " & sql1 & " ", conn, 1, 1
                rs2.open "select sum(edzdjb_x03.ajlbV) as expr1 from edzdjb03,edzdjb_x03,ajlb where edzdjb03.bh=edzdjb_x03.bh and edzdjb_x03.ajlb_code=ajlb.ajlb_code and ajlb.ajlb_code='" & rs("ajlb_code") &"' " & sql2 & " ", conn, 1, 1
                response.write "<tr>"
                response.write "<td align=center rowspan="&rs.recordcount&" colspan=2>利息收入</td>"
                if rs1.recordcount>0 then
                  if not rs1.eof then
                    byhj=byhj+rs1("expr1")
                    response.write "<td>" & rs1("expr1") & "</td>"
              ...
              rs.close
              fl=true
              rs.open "select * from ajlb where ajlb_code='" & "0304000000" &"' ", conn, 1, 1
              if rs.recordcount>0 then
                rs1.open "select sum(edzdjb_x03.ajlbV) as expr1 from edzdjb03,edzdjb_x03,ajlb where edzdjb03.bh=edzdjb_x03.bh and edzdjb_x03.ajlb_code=ajlb.ajlb_code and ajlb.ajlb_code='" & rs("ajlb_code") &"' " & sql1 & " ", conn, 1, 1
                rs2.open "select sum(edzdjb_x03.ajlbV) as expr1 from edzdjb03,edzdjb_x03,ajlb where edzdjb03.bh=edzdjb_x03.bh and edzdjb_x03.ajlb_code=ajlb.ajlb_code and ajlb.ajlb_code='" & rs("ajlb_code") &"' " & sql2 & " ", conn, 1, 1
                response.write "<tr>"
                response.write "<td align=center rowspan="&rs.recordcount&" colspan=2>溢余收入</td>"
                if rs1.recordcount>0 then
                  if not rs1.eof then
                    byhj=byhj+rs1("expr1")
                    response.write "<td>" & rs1("expr1") & "</td>"
              ...
              rs.close
              response.write "<tr>"
              response.write "<td colspan=2 align=center>收入合计</td>"
              response.write "<td align=center>" &byhj & "</td>"
              response.write "<td align=center>" &bnlj & "</td>"
              response.write "</tr>"
              response.write "<tr><td colspan=4 align=center>补充资料</td></tr>"
              fl=true
              rs.open "select * from ajlb where ajlb_code='" & "0305000000" &"' ", conn, 1, 1
              if rs.recordcount>0 then
                rs1.open "select sum(edzdjb_x03.ajlbV) as expr1 from edzdjb03,edzdjb_x03,ajlb where edzdjb03.bh=edzdjb_x03.bh and edzdjb_x03.ajlb_code=ajlb.ajlb_code and ajlb.ajlb_code='" & rs("ajlb_code") &"' " & sql1 & " ", conn, 1, 1
                if rs1.recordcount>0 then
                  if not rs1.eof then
                    response.write "<tr><td colspan=4 align=left>一.上年同期收入:" & rs1("expr1") &"元</td></tr>"
                    if byhj*1.0/rs1("expr1")-1>=0 then
                      response.write "<tr><td colspan=4 align=left>二.本年收入与上年同期收入对比升(" & abs(byhj*1.0/rs1("expr1")-1) &")降()%</td></tr>"
                    else
                      response.write "<tr><td colspan=4 align=left>二.本年收入与上年同期收入对比升()降(" & abs(byhj*1.0/rs1("expr1")-1) &")%</td></tr>"
                    end if
                  else
                    response.write "<tr><td colspan=4 align=left>一.上年同期收入:        元</td></tr>"
                    response.write "<tr><td colspan=4 align=left>二.本年收入与上年同期收入对比升(   )降(   )%</td></tr>"
                  end if
                else
                  response.write "<tr><td colspan=4 align=left>一.上年同期收入:        元</td></tr>"
                  response.write "<tr><td colspan=4 align=left>二.本年收入与上年同期收入对比升(   )降(   )%</td></tr>"
              ...
              rs.close
              response.write "<tr><td colspan=4 align=left>三.征收情况说明<br><br><br></td></tr>"
              %>
            </table>
          </td>
        </tr>
